...
// profile.php
// User account page.
// Allows logged-in users to update their details and view previous orders.
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_profile'])) {
    ...
    // Check that required information is valid.
    if ($fullName === '' || !filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        // Update session data so the new name appears immediately.
...
<input type="text"
       value="<?= h(date('F j, Y', strtotime($user['created_at']))) ?>"
       disabled>
...
<td>
<?= h(date('M j, Y', strtotime($o['created_at']))) ?>
</td>
...
<span class="badge badge-capitalize">
...
// Close order query and load footer.
